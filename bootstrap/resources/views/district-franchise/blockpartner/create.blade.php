                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Add Block Partner</h4>
    ...
    @endif
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{ url('/district-franchise/blockpartner/store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <div class="row gy-4">
                                        ...
                                        <div>
                                            ...
                                            <select class="form-control" name="block_id" required>
                                                ...
                                                @foreach ($block_row as $block_details)
                                                    <option value="{{ $block_details->id }}">{{ $block_details->block }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
