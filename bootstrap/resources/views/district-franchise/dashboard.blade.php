...
@php
    $total_blockpartner=DB::table('blockpartners')->where('district_partner_id','=',Auth::guard('districtpartner')->user()->id)->count();
    $total_employee=DB::table('employees')->where('district_partner_id','=',Auth::guard('districtpartner')->user()->id)->count();
    $total_merchant=DB::table('merchants')->where('district_partner_id','=',Auth::guard('districtpartner')->user()->id)->count();
    $total_user=1;
                    ...
                    <div class="row">
                        <div class="col-xxl-12">
                            <div class="d-flex flex-column h-100">
                               <p style="color:brown;font-size:18px;">Hello , <b>{{ Auth::guard('districtpartner')->user()->name }}</b></p>
                               <div id="test">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        ...
                                                        <a href="{{ url('district-franchise/blockpartner') }}"><p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> View</span></p></a>
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        ...
                                                        <a href="{{ url('district-franchise/employee') }}"><p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> View</span></p></a>
                                                    </div>
                                                    <div>
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <span class="avatar-title bg-soft-info rounded-circle fs-2">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        ...
                                                        <a href="{{ url('district-franchise/merchant') }}"><p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> View</span></p></a>
                                                    </div>
                                                    <div>
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <span class="avatar-title bg-soft-info rounded-circle fs-2">
