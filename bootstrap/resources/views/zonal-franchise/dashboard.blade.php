...
@php
    $total_districtpartner=DB::table('districtpartners')->where('zone_partner_id','=',Auth::guard('zonepartner')->user()->id)->count();
    $total_blockpartner=DB::table('blockpartners')->where('zone_partner_id','=',Auth::guard('zonepartner')->user()->id)->count();
    $total_employee=DB::table('employees')->where('zone_partner_id','=',Auth::guard('zonepartner')->user()->id)->count();
    $total_merchant=DB::table('merchants')->where('zone_partner_id','=',Auth::guard('zonepartner')->user()->id)->count();
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <p class="fw-medium text-muted mb-0">District Partners</p>
                                                        ...
                                                        <a href="{{ url('/zonal-franchise/district-partner') }}"><p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> View</span></p></a>
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <p class="fw-medium text-muted mb-0">Block Partners</p>
                                                        ...
                                                        <a href="{{ url('/zonal-franchise/block-partner') }}"><p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> View</span></p></a>
                                                    </div>
                                                    <div>
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <span class="avatar-title bg-soft-info rounded-circle fs-2">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        ...
                                                        <a href="{{ url('/zonal-franchise/employee') }}"><p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> View</span></p></a>
                                                    </div>
                                                    <div>
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <span class="avatar-title bg-soft-info rounded-circle fs-2">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        ...
                                                        <a href="{{ url('/zonal-franchise/merchant') }}"><p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> View</span></p></a>
                                                    </div>
                                                    <div>
                                                        <div class="avatar-sm flex-shrink-0">
                                                            <span class="avatar-title bg-soft-info rounded-circle fs-2">
