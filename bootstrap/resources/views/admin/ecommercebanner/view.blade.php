                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Ecommerce Banner List <a href="{{ url('/admin/ecommercebanner/create') }}"><button class="btn btn-primary">Add+</button></a></h5>
                        ...
                        <div class="card-body">
                            <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    @php
                                    $row=DB::table('ecommercebanners')->get();
                                    @endphp
                                    @foreach ($row as $details)
                                        ...
                                        <tr>
                                            ...
                                            <form action="{{url('/admin/ecommercebanner/delete')}}" method="post" id="delete_submit{{$details->id}}" style="display:none;">
