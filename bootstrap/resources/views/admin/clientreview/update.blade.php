...
@php
    $details=DB::table('client_reviews')->where('id',$id)->first();
@endphp
<div class="main-content">
    ...
    <h4 class="card-title mb-0 flex-grow-1">Update Client Review</h4>
    ...
    @endif
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{url('/admin/clientreview/update')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="designation" placeholder="Enter Designation" value="{{ $details->designation }}" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            <label for="placeholderInput" class="form-label">Comment*</label>
                                            <input type="text" class="form-control" name="comment" placeholder="Enter Comment" value="{{ $details->comment }}" required>
                                        </div>
                                    </div>
