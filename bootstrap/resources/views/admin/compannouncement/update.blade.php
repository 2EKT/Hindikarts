...
@php
    $details=DB::table('comp_announcements')->where('id',$id)->first();
@endphp
<div class="main-content">
    ...
    <h4 class="card-title mb-0 flex-grow-1">Update Company Announcement</h4>
    ...
    @endif
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{url('/admin/company-announcement/update')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <div class="row gy-4">
