                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Team Member List <a href="{{ url('/admin/teammember/create') }}"><button class="btn btn-primary">Add+</button></a></h5>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($row as $details)
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{url('/admin/teammember/edit/'.$details->id)}}"><i data-feather="edit"></i></a></td>
                                            <td><i data-feather="archive" onclick="delete_row({{$details->id}})"></i></td>
                                            <form action="{{url('/admin/teammember/delete')}}" method="post" id="delete_submit{{$details->id}}" style="display:none;">
