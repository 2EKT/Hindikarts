    ...
    @endif
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{url('/employee/merchant/update')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-xxl-3 col-md-4">
                                            <div>
                                                <label for="placeholderInput" class="form-label">Merchant Type*</label>
                                                <select class="form-control" name="merchant_type_id" id="merchant_type_id" required>
                                                    <option value="">Select Type</option>
                                                    @php
                                                    $types=DB::table('merchanttypes')->get();
                                                    @endphp
                                                    @foreach ($types as $type)
                                                    <option value="{{ $type->id }}" {{ $type->id==$details->merchant_type_id ?'selected':'' }}>{{ $type->type }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                         </div>
