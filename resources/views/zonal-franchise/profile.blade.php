    ...
    @endif
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{ url('/zonal-franchise/update_profile') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="name" placeholder="Name" value="{{ Auth::guard('zonepartner')->user()->name }}" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            <label for="formFile" class="form-label">Email*</label>
                                            <input class="form-control" type="text" name="email" placeholder="Email" value="{{ Auth::guard('zonepartner')->user()->email }}" required>
                                        </div>
                                    </div>
