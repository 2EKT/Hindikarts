                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Completed Order List</h5>
                        ...
                        <div class="card-body">
                            <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    $row=DB::table('orders')->where('status','=', 'completed')->whereIn('id', $order_ids)->orderBy('id', 'desc')->get();
                                    @endphp
                                    @foreach ($row as $details)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{date('d/m/y g:i A', strtotime($details->delivery_date))}}</td>
