                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    @php
                                    $row=DB::table('employees')->where('block_partner_id',Auth::guard('blockpartner')->user()->id)->get();
                                    @endphp
                                    @foreach ($row as $details)
                                        <tr>
                                            ...
                                            {{-- <td><a href="{{url('/block-franchise/employee/edit/'.$details->id)}}"><i data-feather="edit"></i></a></td>
                                            <td><i data-feather="archive" onclick="delete_row({{$details->id}})"></i></td>
                                            <form action="{{url('/block-franchise/employee/delete')}}" method="post" id="delete_submit{{$details->id}}" style="display:none;">
