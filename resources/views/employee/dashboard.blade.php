...
@php
    ...
    $total_merchant=DB::table('merchants')->where('employer_id','=',Auth::guard('employee')->user()->id)->count();
    $total_user=1;
                    ...
                    <div class="row">
                        <div class="col-xxl-12">
                            <div class="d-flex flex-column h-100">
                                ...
                                <p style="color:brown;font-size:18px;">Hello , <b>{{ Auth::guard('employee')->user()->name }}</b></p>
                                <div class="row">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        ...
                                                        <a href="{{ url('/employee/merchant') }}"><p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> View</span></p></a>
                                                    </div>
                                                    <div>
