                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Create Document</h4>
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-6 col-md-6">
                                        <div>
                                            <label for="placeholderInput" class="form-label">Upload document*</label>
                                            <input type="file" class="form-control" name="file_name" required>
                                        </div>
                                     </div>
                                </div>
                                <div class="row">
                                    <div class="col-xxl-6 col-md-6 pt-4">
