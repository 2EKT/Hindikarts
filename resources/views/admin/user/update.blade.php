                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <input type="tel" class="form-control" name="phone" placeholder="Mobile No" value="{{$user->phone}}" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" onkeypress="if(this.value.length==10) return false;" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <input type="hidden" class="form-control" name="previous_image" value="{{ $user->image }}">
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                            <label for="formFile" class="form-label">Create Password*</label>
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input type="password" class="form-control pe-5 password-input" onpaste="return false" name="password" value="{{$user->password}}" placeholder="Enter password" required>
                                    ...
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <select class="form-control" name="active_status" required>
                                                <option value="YES" {{$user->active_status=='YES'?'selected':''}}>YES</option>
                                                <option value="NO" {{$user->active_status=='NO'?'selected':''}}>NO</option>
                                            </select>
                                        </div>
                                    </div>
