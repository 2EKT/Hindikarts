                            ...
                            <div class="live-preview">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            <label for="placeholderInput" class="form-label">Service Name*</label>
                                            <input type="text" class="form-control" name="service" placeholder="Service Name" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            <label for="placeholderInput" class="form-label">Short Description*</label>
                                            <textarea class="form-control" name="description" placeholder="Write Short Description" required></textarea>
                                        </div>
                                    </div>
