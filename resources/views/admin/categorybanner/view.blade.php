                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Category Banner List <a href="{{ url('/admin/categorybanner/create') }}"><button class="btn btn-primary">Add+</button></a></h5>
                        ...
                        <div class="card-body">
                            <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    @php
                                    $row=DB::table('categorybanners')->get();
                                    @endphp
                                    @foreach ($row as $details)
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{url('/admin/categorybanner/edit/'.$details->id)}}"><i data-feather="edit"></i></a></td>
                                            <td><i data-feather="archive" onclick="delete_row({{$details->id}})"></i></td>
                                            <form action="{{url('/admin/categorybanner/delete')}}" method="post" id="delete_submit{{$details->id}}" style="display:none;">
