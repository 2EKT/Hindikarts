...
<body>
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                {{-- <a href="{{ url('/') }}" class="d-inline-block auth-logo" style="background: #fff;padding: 10px;"> --}}
                                    {{-- <img src="{{ asset('assets/images/logo-light.png')}}" alt="" style="height: 65px;"> --}}
                                {{-- </a> --}}
                            </div>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted" style="font-size: 22px;color: navy !important;font-weight: 500;">Admin Panel</p>
                                </div>
    ...
    <!-- particles js -->
    <script src="{{ asset('dashboard_assets/libs/particles.js/particles.js')}}"></script>
    <!-- particles app js -->
    <script src="{{ asset('dashboard_assets/js/pages/particles.app.js')}}"></script>
    <!-- validation init -->
