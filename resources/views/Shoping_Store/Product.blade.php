...
$mega_id = Request::segment(3);
$megacategories = DB::table('megacategories')
                                            ->where('id',$mega_id)
                                            ->first();
$products = DB::table('products')->where('megacat_id',$megacategories->id)->get();
@endphp
    ...
    <div class="agile_inner_breadcrumb">
        <div class="container">
            <ul class="w3_short">
                ...
                <li>{{$megacategories->megacategory}}</li>
            </ul>
        </div>
    </div>
</div>
                            ...
                            <div class="col-md-4 product-men">
                                ...
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item text-center">
                                        <img src="{{ asset('product_image/' . $data->main_image) }}" width="200" alt="">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="{{url('/product/'.$data->id)}}" class="link-product-add-cart">Quick View</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item-info-product text-center border-top mt-4">
                                        ...
                                        <div class="info-product-price my-2">
                                            <span class="item_price">₹{{ $data->market_price }}</span>
                                            {{-- <del>$280.00</del> --}}
                                        </div>
                                        @auth('web')
