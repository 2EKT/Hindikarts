@include('Shoping_Store.include.header')
    ...
    <?php
    $carousel = '';
    $carousel = DB::table('ecommercebanners')->get(); ?>
        ...
        <div class="carousel-inner ">
            @foreach ($carousel as $key => $data)
                <div class="carousel-item  {{ $key == 0 ? 'active' : '' }}">
                    <img src="{{ asset('banner_image/' . $data->image) }}" class="d-block w-100" alt="...">
            ...
            <div class="row">
                ...
                <div class="agileinfo-ads-display col-lg-9">
                    <div class="wrapper">
                                ...
                                @foreach ($product as $data)
                                    <div class="col-md-4 product-men mt-5">
                                        <div class="men-pro-item simpleCart_shelfItem">
                                          ...
                                          <a class="btn btn-danger btn-lg mt-3" onclick="login()" href="javascript:void(0)"
                                                role="button">Buy Now </a>
                        ...
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-4 product-men mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{ asset('shoping_kart/images/m4.jpg') }}" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="single.html" class="link-product-add-cart">Quick View</a>
                                                </div>
                                ...
                                <div class="col-md-4 product-men mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{ asset('shoping_kart/images/m5.jpg') }}" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="single.html" class="link-product-add-cart">Quick View</a>
                                                </div>
                                ...
                                <div class="col-md-4 product-men mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{ asset('shoping_kart/images/m6.jpg') }}" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="single.html" class="link-product-add-cart">Quick View</a>
                                                </div>
                        ...
                        <div class="product-sec1  px-sm-5 px-3">

                            {{-- <div class="row">
								<h3 class="col-md-4 effect-bg">Summer Carnival</h3>
								<p class="w3l-nut-middle">Get Extra 10% Off</p>
								<div class="col-md-8 bg-right-nut">
									<img src="{{asset('shoping_kart/images/image1.png')}}" alt="">
								</div>
							</div> --}}
                            @php
                                $discount = DB::table('best_discounts')->get();
                            @endphp
                            <div class="row">
                                ...
                                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner ">
                                        ...
                                        @foreach ($discount as $key => $data)
                                            <div class="carousel-item  {{ $key == 0 ? 'active' : '' }}">
                                                {{-- <div class="col-md-8 bg-right-nut"> --}}
                                                <img src="{{ asset('banner_image/' . $data->image) }}" width="500"
                                                    alt="...">
                        ...
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mt-4">
                            ...
                            <div class="row">
                                <div class="col-md-4 product-men mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{ asset('shoping_kart/images/m7.jpg') }}" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="single.html" class="link-product-add-cart">Quick View</a>
                                                </div>
                                ...
                                <div class="col-md-4 product-men mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{ asset('shoping_kart/images/m8.jpg') }}" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="single.html" class="link-product-add-cart">Quick View</a>
                                                </div>
                                ...
                                <div class="col-md-4 product-men mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{ asset('shoping_kart/images/m9.jpg') }}" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="single.html" class="link-product-add-cart">Quick View</a>
                                                </div>
                                ...
                                <div class="scroll">
                                    <div class="row">
                                        <div class="col-lg-3 col-sm-2 col-3 left-mar">
                                            <img src="{{ asset('shoping_kart/images/k1.jpg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                        <div class="col-lg-9 col-sm-10 col-9 w3_mvd">
                                            <a href="">Samsung Galaxy On7 Prime (Gold, 4GB RAM + 64GB
                                                Memory)</a>
                                    ...
                                    <div class="row my-4">
                                        <div class="col-lg-3 col-sm-2 col-3 left-mar">
                                            <img src="{{ asset('shoping_kart/images/k2.jpg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                        <div class="col-lg-9 col-sm-10 col-9 w3_mvd">
                                            <a href="">Haier 195 L 4 Star Direct-Cool Single Door
                                                Refrigerator</a>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-sm-2 col-3 left-mar">
                                            <img src="{{ asset('shoping_kart/images/k3.jpg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                        <div class="col-lg-9 col-sm-10 col-9 w3_mvd">
                    ...
                    <div class="join-agile text-left p-4">
                        <div class="row">
                            ...
                            <div class="col-sm-5 offerimg-w3l">
                                <img src="{{ asset('shoping_kart/images/off1.png') }}" alt=""
                                    class="img-fluid">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 mt-lg-0 mt-5">
                    <div class="join-agile text-left p-4">
                        <div class="row ">
                            ...
                            <div class="col-sm-5 offerimg-w3l">
                                <img src="{{ asset('shoping_kart/images/off2.png') }}" alt=""
                                    class="img-fluid">
                            </div>
                        </div>
                    </div>
