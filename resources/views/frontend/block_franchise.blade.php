...
<html>
<head>
	<title>Block Franchise || Hindkart</title>
	...
	<section class="block-franchise">
		<div class="container">
		    <div class="text-center">
			    ...
			    <p>To provide best service to our merchants and customers or users we are offering Franchise in every city in India. Every franchise partners will work for the develop their own area on commission basis. We are looking for them as a Franchise Partners who have working ability and experience in this field. Every Block Franchise has to start their business with minimum three Marketing Representative for his/her area. All the Blocks will be controlled by the District Franchise partner, and 5-7 District will be controlled by the Zonal Franchise Partners.</p>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="heading-box"  style="margin-top:50px;">
						<h2> BLOCK FRANCHISE</h2>
						</div>
						<h5 style="margin-top:10px;margin-bottom:10px;">Requirements: </h5>
        			    <ul>
        			        <li>An Office (No size Requirements)</li>
                            <li> A Desktop/Laptop with Printer</li>
                            <li> Minimum 10 th Pass</li>
                            <li> Photo ID and Bank A/C</li>
                            <li> 1 year experience in this field</li>
        			    </ul>
        			    <h5 style="margin-top:10px;margin-bottom:10px;">Duties: </h5>
        			    <ul>
                            <li>	Arrange 3-5 Marketing Representative for your area,</li>
                            <li>	Communicate with the MR and Merchant to help them grow their business,</li>
                            <li>	Control, motivate and tra k your employees,</li>
                            <li>	Selection Bike Riders and Delivery boys as a merchant from your locality and ask to district for approval,</li>
                            <li>	Check COD collection amount properly send or not to company from you delivery partners,</li>
                            <li>	All the Merchants, Delivery Boys, Employees are directly connecting with you.</li>
                            <li>	Monthly Subscriptions collection,</li>
                            <li>	Reporting to District fran hise regularly and
                            follow the Company Guid lines properly.</li>
        			    </ul>
        			    ...
        			    <h6 style="margin-top:10px;"><b> Investment: </b><span>Registration Fees - 3000/- (including GST) (Non Refundable) <br> Security Amount :</b> 7000/- (Refundable*)</span></h6>
                        <h6 style="margin-top:5px;"><b> Monthly Subscriptions : </b><span> Rs 999+GST= 1179/- </span></h6>
                        <h6 style="margin-top:5px;"><b> Earning : </b><span>	Below 2L 12% of net Collection 2L or above 15% . </span></h6>
                        <h6 style="margin-top:5px;"><b> Earning Possibility : </b><span>	30k – 75k</span> </h6>
				</div>
				<div class="col-md-6">
				<div class="contact-form" style="margin-top: 100px;">
				    <h3 style="margin-top:20px;margin-bottom:10px;">Are You Interested? Feel free to submit the form!</h3>
