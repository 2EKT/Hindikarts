...
<html>
<head>
	<title>Zonal Franchise || Hindkart</title>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="heading-box" style="margin-top:50px;">
        			    ...
        			    <h6 style="margin-top:10px;"><b> Investment: </b><span>Registration Fees - 10000/- (inc GST / Non Refundable) <br> Security Amount - 25000/-(Refundable*) </span></h6>
                        <h6 style="margin-top:5px;"><b> Monthly Subscriptions : </b><span> Rs 4999+GST= 5899/-  </span></h6>
                        <h6 style="margin-top:5px;"><b> Earning : </b><span>	Below 40L 2% of net Collection 40 or above 3%. </span></h6>
				</div>
				<div class="col-md-6">
			 ...
			 <h5 class="last">NB: Payout will be regularly and commission not fixed, it will increase or decrease without any prior notice.</h5>
		</div>
