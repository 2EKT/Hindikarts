    ...
    @endif
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{url('/district-franchise/blockpartner/update')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-xxl-3 col-md-4">
                                            <div>
                                                ...
                                                <select class="form-control" name="block_id" required>
                                                    ...
                                                    @php
                                                    $block_row=DB::table('block')->where('district_id',Auth::guard('districtpartner')->user()->district_id)->get();
                                                    @endphp
