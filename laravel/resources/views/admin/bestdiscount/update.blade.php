...
@php
    $details=DB::table('best_discounts')->where('id',$id)->first();
@endphp
<div class="main-content">
    ...
    <h4 class="card-title mb-0 flex-grow-1">Update Best Discount</h4>
    ...
    @endif
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{url('/admin/best-discount/update')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <div class="row gy-4">
