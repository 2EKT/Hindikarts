                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Create Zone Partner</h4>
    ...
    @endif
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{ url('/admin/zonepartner') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <div class="row gy-4">
                                        ...
                                        <div>
                                            ...
                                            <select class="form-control" name="zone_id" required>
                                                ...
                                                @foreach ($zone_row as $zone_details)
                                                    <option value="{{ $zone_details->id }}">{{ $zone_details->zone_title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
