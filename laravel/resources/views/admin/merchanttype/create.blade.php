                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Create Merchant Type</h4>
    ...
    @endif
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{ url('/admin/merchanttype') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <div class="row gy-4">
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <select class="form-control" name="service_id" required>
                                                ...
                                                <option value="{{ $details->id }}">{{ $details->service }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <input type="number" class="form-control" name="registration_fee" placeholder="Registration Fee" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            <label for="placeholderInput" class="form-label">Monthly Fee*</label>
                                            <input type="number" step="any" class="form-control" name="monthly_fee" placeholder="Monthly Fee" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
