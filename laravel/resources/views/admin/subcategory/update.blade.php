                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                ...
                                <div class="row gy-4">
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <select class="form-control" name="cat_id" required>
                                                ...
                                                <option value="{{ $cat_details->id }}" {{ $subcategory->cat_id==$cat_details->id?'selected':'' }}>{{ $cat_details->category }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            <label for="placeholderInput" class="form-label">Sub Category Name*</label>
                                            <input type="text" class="form-control" name="subcategory" placeholder="Sub Category Name" value="{{$subcategory->subcategory}}" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
